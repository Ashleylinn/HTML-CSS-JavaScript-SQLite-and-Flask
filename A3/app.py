...
if __name__ == '__main__':
    with app.app_context():
        ...
        if not RemarkRequests.query.first():
            remarkreq1 = RemarkRequests(student_id=1, case_name='assign1', reason="I think my solution is correct, please recheck question 3.", status='Pending')
            remarkreq2 = RemarkRequests(student_id=2, case_name='lab2', reason="I think there is a midtake in question 1.", status='Pending')

            db.session.add_all([remarkreq1, remarkreq2])
            db.session.commit()
